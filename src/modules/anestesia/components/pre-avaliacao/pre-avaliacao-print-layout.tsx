...
export function PreAvaliacaoPrintLayout({ data, dataAvaliacao }: Props) {
  const today =
    dataAvaliacao ??
    ...
    >
      ...
      <div className="grid grid-cols-12 gap-3">
        ...
        <SectionCard className="col-span-12">
          ...
          <div className="grid grid-cols-12 gap-3">
            <PrintField label="Nome do Paciente" value={data.nomePaciente} className="col-span-4" />
